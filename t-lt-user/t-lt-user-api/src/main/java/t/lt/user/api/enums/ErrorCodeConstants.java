package t.lt.user.api.enums;

import service.lt.common.exception.ErrorCode;
...
public interface ErrorCodeConstants {
    ...
    // ========== 机构模块 1002004000 ==========
    ErrorCode DEPT_NAME_DUPLICATE = new ErrorCode(1002004000, "已经存在该名字的机构");
    ErrorCode DEPT_PARENT_NOT_EXITS = new ErrorCode(1002004001,"父级机构不存在");
    ErrorCode DEPT_NOT_FOUND = new ErrorCode(1002004002, "当前机构不存在");
    ErrorCode DEPT_EXITS_CHILDREN = new ErrorCode(1002004003, "存在子机构，无法删除");
    ErrorCode DEPT_PARENT_ERROR = new ErrorCode(1002004004, "不能设置自己为父机构");
    ErrorCode DEPT_EXISTS_USER = new ErrorCode(1002004005, "机构中存在员工，无法删除");
    ErrorCode DEPT_NOT_ENABLE = new ErrorCode(1002004006, "机构不处于开启状态，不允许选择");
    ErrorCode DEPT_PARENT_IS_CHILD = new ErrorCode(1002004007, "不能设置自己的子机构为父机构");
    ...
    ErrorCode OCR_CHANNEL_NOT_EXISTS = new ErrorCode(1001007002, "ocr渠道不存在");
    ErrorCode OCR_CHANNEL_CODE_EXISTS = new ErrorCode(1001007011, "ocr渠道编码已存在");
    ErrorCode OCR_CHANNEL_NAME_EXISTS = new ErrorCode(1001007012, "ocr渠道名称已存在");

    ErrorCode OCR_CHANNEL_DISABLE = new ErrorCode(1001007003, "ocr渠道不处于开启状态，不允许选择");
    ErrorCode OCR_TEMPLATE_NOT_EXISTS = new ErrorCode(1001007004, "ocr模板不存在");
    ErrorCode OCR_TEMPLATE_CODE_DUPLICATE = new ErrorCode(1001007005, "已经存在编码为【{}】的ocr模板");


    ErrorCode Verify_TEMPLATE_NOT_EXISTS = new ErrorCode(1001007006, "verify模板不存在");
    ErrorCode Verify_CHANNEL_NOT_EXISTS = new ErrorCode(1001007007, "verify渠道不处于开启状态，不允许选择");
    ErrorCode Verify_CHANNEL_DISABLE = new ErrorCode(1001007008, "verify渠道不存在");
    ErrorCode Verify_TEMPLATE_CODE_DUPLICATE = new ErrorCode(1001007009, "已经存在编码为【{}】的verify模板");
}
