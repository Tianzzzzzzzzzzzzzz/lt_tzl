package t.lt.user.biz.service.oauth2;
...
import service.lt.common.util.string.StrUtils;
import t.lt.user.biz.controller.oauth2.vo.client.OAuth2ClientCreateReqVO;
import t.lt.user.biz.controller.oauth2.vo.client.OAuth2ClientPageReqVO;
import t.lt.user.biz.controller.oauth2.vo.client.OAuth2ClientUpdateReqVO;
import t.lt.user.biz.convert.user.oauth2.OAuth2ClientConvert;
import t.lt.user.biz.dal.dataobject.oauth2.OAuth2ClientDO;
import t.lt.user.biz.dal.mysql.oauth2.OAuth2ClientMapper;
...
import static service.lt.common.util.collection.CollectionUtils.convertMap;
